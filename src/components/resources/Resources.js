...
const Resources = () => {
  return (
    <div className="resources">
      <img src={scholars} width="60%" height="140px" alt="scholarships banner" />
      <div className="resources__section">
        <section>
          <a
            href="http://www.tmcf.org/students-alumni/scholarships/"
            target="#"
          >
            <img
